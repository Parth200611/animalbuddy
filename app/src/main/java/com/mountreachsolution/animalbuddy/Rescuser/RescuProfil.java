...
import com.mountreachsolution.animalbuddy.Loginactivity;
...
public class RescuProfil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_rescu_profil, container, false);
    ...
    private void UserImageSaveTodatabase(Bitmap bitmap, String strTitle) {
        VolleyMultipartRequest volleyMultipartRequest =  new VolleyMultipartRequest(Request.Method.POST, urls.profilimg, new Response.Listener<NetworkResponse>() {
            @Override

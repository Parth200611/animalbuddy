...
public class PostComplaint extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_post_complaint, container, false);
    ...
    private void PostWork(String username, String location, String details) {
        ...
        client.post(urls.Posthelp,params,new JsonHttpResponseHandler(){
            @Override
    ...
    private void UserImageSaveTodatabase(Bitmap bitmap, String strTitle) {
        VolleyMultipartRequest volleyMultipartRequest =  new VolleyMultipartRequest(Request.Method.POST, urls.Postimg, new Response.Listener<NetworkResponse>() {
            @Override
